...
extern void SetUpLyraHostApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<LyraHostApi> *_Nullable api);

extern void SetUpLyraHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<LyraHostApi> *_Nullable api, NSString *messageChannelSuffix);
