...
class _PayzenHostApiCodec extends StandardMessageCodec {
  const _PayzenHostApiCodec();
  @override
...
class PayzenHostApi {
  /// Constructor for [PayzenHostApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  PayzenHostApi({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;

  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _PayzenHostApiCodec();

  Future<LyraKeyInterface> initialize(LyraKeyInterface arg_lyraKey) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.PayzenHostApi.initialize', codec,
