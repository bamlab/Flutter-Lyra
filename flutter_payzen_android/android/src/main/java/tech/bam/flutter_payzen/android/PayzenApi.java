...
public class PayzenApi {
  ...
  private static class PayzenHostApiCodec extends StandardMessageCodec {
    public static final PayzenHostApiCodec INSTANCE = new PayzenHostApiCodec();
    private PayzenHostApiCodec() {}
    @Override
      ...
      } else 
{
  ...
  public interface PayzenHostApi {
    void initialize(@NonNull LyraKeyInterface lyraKey, Result<LyraKeyInterface> result);

    /** The codec used by PayzenHostApi. */
    static MessageCodec<Object> getCodec() {
      return PayzenHostApiCodec.INSTANCE;
    }

    /** Sets up an instance of `PayzenHostApi` to handle messages through the `binaryMessenger`. */
    static void setup(BinaryMessenger binaryMessenger, PayzenHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.PayzenHostApi.initialize", getCodec());
        if (api != null) {
