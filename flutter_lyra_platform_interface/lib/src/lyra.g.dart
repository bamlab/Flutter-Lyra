...
class LyraHostApi {
  ...
  Future<LyraKeyInterface> initialize(LyraKeyInterface arg_lyraKey) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.flutter_lyra_platform_interface.LyraHostApi.initialize',
        codec,
  ...
  Future<int> getFormTokenVersion() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.flutter_lyra_platform_interface.LyraHostApi.getFormTokenVersion',
        codec,
        binaryMessenger: _binaryMessenger);
  ...
  Future<String> process(ProcessRequestInterface arg_request) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.flutter_lyra_platform_interface.LyraHostApi.process',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
